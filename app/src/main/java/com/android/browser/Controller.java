...
public class Controller
    ...
    public void onPause() {
        ...
        ReflectUtils.getInstance().disablePlatformNotifications();
    ...
    public void onResume() {
        ...
        ReflectUtils.getInstance().enablePlatformNotifications();
    ...
    public void getVisitedHistory(final ValueCallback<String[]> callback) {
        AsyncTask<Void, Void, String[]> task =
            ...
            public String[] doInBackground(Void... unused) {
                return ReflectUtils.getInstance().getVisitedHistory(mActivity.getContentResolver());
            }
            @Override
    ...
    public void onReceivedHttpAuthRequest(Tab tab, WebView view,
        ...
        if (username != null && password != null) {
            ...
            if (tab.inForeground() && !ReflectUtils.getInstance().suppressDialog(handler)) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.dump_nav_menu_id:
                ReflectUtils.getInstance().debugDump(getCurrentTopWebView());
                break;
    ...
    public Intent createBookmarkCurrentPageIntent(boolean editExisting) {
        ...
        String touchIconUrl = ReflectUtils.getInstance().getTouchIconUrl(w);
    ...
    static Bitmap createScreenshot(WebView view, int width, int height) {
        if (view == null || view.getContentHeight() == 0
                || ReflectUtils.getInstance().getContentWidth(view) == 0) {
            return null;
        }
        ...
        int contentWidth = ReflectUtils.getInstance().getContentWidth(view);
