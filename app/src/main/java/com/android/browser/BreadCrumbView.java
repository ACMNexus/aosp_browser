...
public class BreadCrumbView extends LinearLayout implements OnClickListener {
    ...
    private void init(Context ctx) {
        ...
        TypedArray a = mContext.obtainStyledAttributes(new int[]{ReflectUtils.getInstance().getAttr("Theme")});
        mSeparatorDrawable = a.getDrawable(ReflectUtils.getInstance().getStyleable("Theme_dividerVertical"));
        a.recycle();
