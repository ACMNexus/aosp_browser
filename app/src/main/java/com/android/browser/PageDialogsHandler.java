...
public class PageDialogsHandler {
    ...
    private AlertDialog.Builder createSslCertificateDialog(SslCertificate certificate,
            SslError error) {
        View certificateView = ReflectUtils.getInstance().inflateCertificateView(certificate, mContext);
        final LinearLayout placeholder =
                (LinearLayout)certificateView.findViewById(ReflectUtils.getInstance().getResourceId("placeholder"));
        ...
        if (error == null) {
            ...
            successString.setText(ReflectUtils.getInstance().getStringId("ssl_certificate_is_valid"));
        } else {
        ...
        return new AlertDialog.Builder(mContext)
                .setTitle(ReflectUtils.getInstance().getStringId("ssl_certificate"))
                .setIcon(iconId)
