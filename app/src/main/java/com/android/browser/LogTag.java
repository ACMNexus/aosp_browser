...
public class LogTag {
    ...
    public static final int BROWSER_BOOKMARK_ADDED = 1001;
    public static final int BROWSER_PAGE_LOADED = 1002;
    public static final int BROWSER_TIMEONPAGE = 1003;
    ...
    public static void logBookmarkAdded(String url, String where) {
        EventLog.writeEvent(BROWSER_BOOKMARK_ADDED, url + "|" + where);
    }
