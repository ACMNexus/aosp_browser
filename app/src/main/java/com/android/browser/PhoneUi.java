...
public class PhoneUi extends BaseUi {
    ...
    public PhoneUi(Activity browser, UiController controller) {
        ...
        browser.getTheme().resolveAttribute(
                ReflectUtils.getInstance().getAttr("actionBarSize"), heightValue, true);
    ...
    void hideNavScreen(int position, boolean animate) {
        ...
        int toLeft = 0;
        int titleHeight = ReflectUtils.getInstance().getVisibleTitleHeight(tab.getWebView());
        int toTop = (tab.getWebView() != null) ? titleHeight : 0;
