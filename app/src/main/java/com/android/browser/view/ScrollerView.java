...
//    private StrictMode.Span mScrollStrictSpan = null;  // aka "drag"
    ...
    public ScrollerView(Context context, AttributeSet attrs) {
        this(context, attrs, ReflectUtils.getInstance().getAttr("scrollViewStyle"));
    }
    ...
    public ScrollerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, new int[]{ReflectUtils.getInstance().getAttr("ScrollView")}, defStyle, 0);
        setFillViewport(a.getBoolean(ReflectUtils.getInstance().getStyleable("ScrollView_fillViewport"), false));
             ...
             */
                ...
                if (yDiff > mTouchSlop) {
                    ...
                    if (mScrollStrictSpan == null) {
                        mScrollStrictSpan = ReflectUtils.getInstance().enterCriticalSpan("ScrollView-scroll");
                    }
                } else {
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                if (!mScroller.isFinished()) {
                    ...
                    if (mFlingStrictSpan != null) {
                        ReflectUtils.getInstance().Span_finish(mFlingStrictSpan);
                ...
                case MotionEvent.ACTION_SCROLL: {
                    if (!mIsBeingDragged) {
                        if (mHorizontal) {
                            ...
                            if (hscroll != 0) {
                                final int delta = (int) (hscroll * ReflectUtils.getInstance().getHorizontalScrollFactor(this));
                                final int range = getScrollRange();
                            ...
                            if (vscroll != 0) {
                                final int delta = (int) (vscroll * ReflectUtils.getInstance().getVerticalScrollFactor(this));
                                final int range = getScrollRange();
    ...
    protected void onOverScrolled(int scrollX, int scrollY,
        ...
        if (!mScroller.isFinished()) {
            setScrollX(scrollX);
            setScrollY(scrollY);
            ReflectUtils.getInstance().invalidateParentIfNeeded(this);
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mScrollStrictSpan != null) {
            ReflectUtils.getInstance().Span_finish(mScrollStrictSpan);
    ...
    public void fling(int velocityY) {
        if (getChildCount() > 0) {
            ...
            if (mFlingStrictSpan == null) {
                mFlingStrictSpan = ReflectUtils.getInstance().enterCriticalSpan("ScrollView-fling");
            }
